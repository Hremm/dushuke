<template>
  <div>
    <van-nav-bar @click-left="$router.go(-1)" left-arrow title="意见反馈" />
    <van-divider
...
>
    ...
    <van-form>
      ...
      <van-field name="uploader" label="上传问题截图">
        <template #input>
          <van-uploader style="border: 1px dashed #ccc;" />
        </template>
      </van-field>
      ...
      <van-button class="btn" type="primary" block>提交</van-button>
    </van-form>
  </div>
</template>
